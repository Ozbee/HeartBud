...
const AddPrescription=()=>{
  ...
  return(
    ...
    <TextInput style={[styles.input,styles.input1]} placeholder="Morning? Afternoon? Evening?" keyboardType="text"/>
    </View>
    
    
    <View style={styles.rowContainers}>
    <Text style={styles.txt}>Medicine:</Text>
    <TextInput style={[styles.input,styles.input1a]} placeholder="Medicine name" keyboardType="text"/>
    </View>

    <View style={styles.rowContainers}>
    <Text style={styles.txt}>Details:</Text>
    <TextInput style={[styles.input,styles.input2]} placeholder="Details of Medicine" keyboardType="text" />
    </View>
...
const styles=StyleSheet.create({
    ...
    input1:{height:35,fontSize:18,width:160},
    input1a:{height:35,fontSize:18,width:150},
    input2:{height:100,fontSize:18,width:160},
    btn:{
